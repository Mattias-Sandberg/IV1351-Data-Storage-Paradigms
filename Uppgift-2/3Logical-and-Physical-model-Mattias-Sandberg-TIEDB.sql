...
ALTER TABLE monthly_fee ADD CONSTRAINT PK_monthly_fee PRIMARY KEY (student_id,discount_id);
...
ALTER TABLE number_of_lessons ADD CONSTRAINT PK_number_of_lessons PRIMARY KEY (instructor_id,student_id,discount_id);
