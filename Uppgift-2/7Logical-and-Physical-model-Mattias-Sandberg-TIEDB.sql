...
ALTER TABLE discount ADD CONSTRAINT FK_discount_0 FOREIGN KEY (student_id) REFERENCES siblings (student_id);
ALTER TABLE discount ADD CONSTRAINT FK_discount_1 FOREIGN KEY (instructor_id,student_id) REFERENCES monthly_fee (instructor_id,student_id);
