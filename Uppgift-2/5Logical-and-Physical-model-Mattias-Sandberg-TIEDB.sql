...
ALTER TABLE siblings ADD CONSTRAINT PK_siblings PRIMARY KEY (student_id,id);
...
ALTER TABLE siblings ADD CONSTRAINT FK_siblings_1 FOREIGN KEY (id) REFERENCES discount (id);
