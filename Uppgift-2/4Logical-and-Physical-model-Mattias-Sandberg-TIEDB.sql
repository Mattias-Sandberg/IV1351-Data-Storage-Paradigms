...
ALTER TABLE booking ADD CONSTRAINT PK_booking PRIMARY KEY (school_id,instructor_id);
...
ALTER TABLE booking ADD CONSTRAINT FK_booking_1 FOREIGN KEY (instructor_id) REFERENCES schedule (instructor_id);


ALTER TABLE discount ADD CONSTRAINT FK_discount_0 FOREIGN KEY (instructor_id,siblings_id) REFERENCES monthly_fee (instructor_id,student_id);
ALTER TABLE discount ADD CONSTRAINT FK_discount_1 FOREIGN KEY (siblings_id) REFERENCES siblings (student_id);
